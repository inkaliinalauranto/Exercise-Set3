...
<img src="./images/image-1.png" alt="Drizzle ORM -kirjaston määrittelytiedosto" style="width: 60%;"/>
...
<img src="./images/image-2.png" alt="sqlite_db.ts-tiedosto" style="width: 60%;"/>
...
<img src="./images/image-3.png" alt="Drizzle ORM -kirjaston määrittelytiedosto" style="width: 40%;"/>
...
<img src="./images/image-4.png" alt="posts-taulun luonti" style="width: 70%;"/>
...
![Sarakkeen määrittely viiteavaimeksi ohjelmallisesti](./images/image-8.png)
...
<img src="./images/image-9.png" alt="relaatioiden ohjelmallinen luonti" style="width: 70%;"/>
...
![Lisätty title-sarake posts-taulussa Drizzle Studion kautta tarkasteltuna](./images/image-10.png)
...
![Aloitusviestin lisääminen](./images/image-11.png)

INSERT-kyselyn jälkeen lisätty tietue näkyy posts-taulussa:

![Lisätty aloitusviesti taulussa](./images/image-12.png)
...
![Aloitusviestien hakeminen Drizzle-kyselyllä](./images/image-16.png)
...
![Ensimmäisen viestin vastausten hakeminen](./images/image-17.png)
...
![Haetaan sekä aloitusviesti että sen vastausviestit](./images/image-18.png)
...
<img src="./images/image-19.png" alt="Viite-eheysongelma aloitusviestin poistamisen yhteydessä" style="width: 70%;"/>
...
![Viite-eheyssäännön ohjelmallinen muuttaminen cascade-arvoon](./images/image-20.png)
...
<img src="./images/image-21.png" alt="Aloitsuviestin poistaminen viite-eheyssäännön cascadeksi muuttamisen jälkeen" style="width: 70%;"/>

Huomataan, ettei posts-taulussa ole aloitusviestin poistamisen jälkeen myöskään viestin vastaustietueita.

![posts-taulu aloitusviestin ja sen vastausviestien poistamisen jälkeen](./images/image-22.png)
...
<img src="./images/image-23.png" alt="Aloitsuviestin poistaminen viite-eheyssäännön cascadeksi muuttamisen jälkeen" style="width: 80%;"/>
